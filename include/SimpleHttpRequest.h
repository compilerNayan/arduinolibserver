...
class SimpleHttpRequest : public IHttpRequest {
    ...
    Public SimpleHttpRequest(CStdString& requestId, RequestSource source, CStdString& rawRequest) 
        : method_(HttpMethod::GET), clientPort_(0), timestamp_(0), source_(source) {
